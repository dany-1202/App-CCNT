...
ctrlCCNT.controller('employeFormController', function($timeout, $rootScope, $scope, $http, $location, SessionService) {
  ...
  $scope.validation = function () {
    ...
    $scope.myEmp.dep = $scope.monDep.name;
    $scope.myEmp.horaire = $scope.monHoraire.name;
