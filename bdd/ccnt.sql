...
INSERT INTO `ccn_personne` (`per_id`, `per_nom`, `per_prenom`, `per_mail`, `per_mdp`, `per_dateNaissance`, `per_adresse`, `per_codePostal`, `per_ville`, `per_admin`) VALUES
(1, 'Bedonni', 'Jean-Pierre', 'jpb@gprh.ch', 'gprh', '1970-01-01', 'Rue de la batelle 5', 1205, 'Geneve', 1);
