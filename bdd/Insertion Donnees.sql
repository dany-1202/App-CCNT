...
--INSERTION des données tests dans la table Etablissement !
...
--INSERTION des données tests dans la table ccn_departement
INSERT INTO `ccn_departement` (`dep_no`, `dep_nom`, `dep_eta_no`) 
VALUES (NULL, 'cuisine', '1');

--INSERTION des données tests dans la table ccn_personne !
INSERT INTO `ccn_personne` (`per_id`, `per_nom`, `per_prenom`, `per_mail`, `per_mdp`, `per_token`, `per_dateNaissance`, `per_adresse`, `per_InfoSuppAdresse`, `per_codePostal`, `per_ville`, `per_admin`, `per_telFixe`, `per_telMobile`, `per_dep_no`) 
