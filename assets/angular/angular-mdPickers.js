                            ...
                            '<md-dialog-content layout-gt-xs="row" layout-wrap>' +
                                '<md-toolbar layout-gt-xs="column" layout-xs="row" layout-align="center center" flex class="mdp-timepicker-time md-hue-1 md-primary">' +
                                    '<div class="mdp-timepicker-selected-time">' +
                                        '<span ng-class="{ \'active\': timepicker.currentView == timepicker.VIEW_HOURS }" ng-click="timepicker.currentView = timepicker.VIEW_HOURS">{{ timepicker.time.format("HH") }}</span>:' + 
                                    ...
                                    '<div layout="column" class="mdp-timepicker-selected-ampm">' + 
                                        '<span class="centrer" ng-click="timepicker.setAM()" ng-class="{ \'active\': timepicker.time.hours() < 12 }">Matin</span>' +
                                        '<span class="centrer" ng-click="timepicker.setPM()" ng-class="{ \'active\': timepicker.time.hours() >= 12 }">Soir</span>' +
                                    '</div>' + 
                                '</md-toolbar>' +
                                '<div>' +
                                    ...
                                    '<md-dialog-actions layout="row">' +
	                                	'<span flex></span>' +
                                        '<md-button style="min-width: 100px!important;" class="md-raised" ng-click="timepicker.cancel()" aria-label="' + LABEL_CANCEL + '">' + LABEL_CANCEL + '</md-button>' +
                                        '<md-button style="min-width: 100px!important;" ng-click="timepicker.confirm()" class="md-raised md-primary" aria-label="' + LABEL_OK + '">' + LABEL_OK + '</md-button>' +
                                    '</md-dialog-actions>' +
                                '</div>' +
                            '</md-dialog-content>' +
                        '</md-dialog>',
