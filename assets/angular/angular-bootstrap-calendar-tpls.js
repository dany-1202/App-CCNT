	...
	angular
	  ...
	  .factory('calendarEventTitle', ["calendarDateFilter", "calendarTruncateEventTitleFilter", function(calendarDateFilter, calendarTruncateEventTitleFilter) {
	    ...
	    function weekView(event) {
	      	if (event.absence.absence) {
	    		return '<span style="color:white;margin-left:3px;margin-bottom:5px">' + '<i class="fa fa-circle" style="color:' + event.color.primary + ';margin-right:3px; border:1px solid white; border-radius:50px"></i> <span style="font-size:1em;margin-right:5px">' + event.title + '</span>';
	    	} else {
	    		return '<span style="color:black;margin-left:3px;margin-bottom:5px">' + '<i class="fa fa-circle" style="color:' + event.color.primary + ';margin-right:3px"></i> <span style="font-size:1em;margin-right:5px">' + event.title + '</span>';
	    	}	event.title;
	    }
